<?php
	...
	if(isset($_POST['title'])){
		...
		VALUES ('".$_SESSION['username']."', '1', '".date("Y-m-d h:i:sa")."', 'DM', '".$_POST['title']."', '".$_POST['text']."')";
...
<body>
	<nav class="navbar bg-dark navbar-dark">
		<!-- Brand -->
		<a class="navbar-brand" href="#">Discrete Mathematics</a>
...
<?php
	$sql = "SELECT * FROM threads WHERE Topic='DM' AND IsMainThread='1'";
