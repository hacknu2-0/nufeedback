<?php
	...
	if(isset($_POST['title'])){
		...
		VALUES ('".$_SESSION['username']."', '1', '".date("Y-m-d h:i:sa")."', 'CS', '".$_POST['title']."', '".$_POST['text']."')";
...
<body>
	<nav class="navbar bg-dark navbar-dark">
		<!-- Brand -->
		<a class="navbar-brand" href="#">Communication Systems</a>
...
<?php
	$sql = "SELECT * FROM threads WHERE Topic='CS' AND IsMainThread='1'";
