<?php
	...
	if(isset($_POST['title'])){
		...
		VALUES ('".$_SESSION['username']."', '1', '".date("Y-m-d h:i:sa")."', 'PHY', '".$_POST['title']."', '".$_POST['text']."')";
...
<body>
	<nav class="navbar bg-dark navbar-dark">
		<!-- Brand -->
		<a class="navbar-brand" href="#">Physics / Electronics</a>
...
<?php
	$sql = "SELECT * FROM threads WHERE Topic='PHY' AND IsMainThread='1'";
