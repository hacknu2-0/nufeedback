<?php
	...
	if(isset($_POST['title'])){
		...
		VALUES ('".$_SESSION['username']."', '1', '".date("Y-m-d h:i:sa")."', 'CAO', '".$_POST['title']."', '".$_POST['text']."')";

		if ($conn->query($sql) === TRUE) {
		    echo "New record created successfully";
		    header("Location: ./cao.php");
		} else {
...
<body>
	<nav class="navbar bg-dark navbar-dark">
		<!-- Brand -->
		<a class="navbar-brand" href="#">CAO</a>
...
<?php
	$sql = "SELECT * FROM threads WHERE Topic='CAO' AND IsMainThread='1'";
