...
$mail->Username = "abstrusev4@gmail.com";                 
$mail->Password = "siNUsoidv4";                           
//If SMTP requires TLS encryption then set it
$mail->SMTPSecure = "tls";                           
//Set TCP port to connect to 
$mail->Port = 587;                                   

$mail->From = "abstrusev4@gmail.com";
$mail->FromName = "NUForum";

session_start();
$mail->addAddress($_SESSION['regmail']);
$mail->isHTML(true);
...
$name = preg_split("/@st.niituniversity.in$/", $_SESSION['regmail']); 
$name2 = preg_split("/@niituniversity.in$/", $_SESSION['regmail']); 
if(strlen($name[0])<strlen($name2[0])){
    $finalname = $name[0];
}
else{
    $finalname = $name2[0];
...
VALUES ('".$finalname."', '".$_SESSION['regmail']."', '".$hash."')";
...
$mail->Body = "<i>Your password for account ".$_SESSION['regmail']." is ".$pass."  <br>Please change your password after logging in. </i>";
...
else 
{
    ...
    header("Location: ./login.php?accreg=1");
}