<?php
	...
	if(isset($_POST['title'])){
		...
		VALUES ('".$_SESSION['username']."', '1', '".date("Y-m-d h:i:sa")."', 'DAA', '".$_POST['title']."', '".$_POST['text']."')";

		if ($conn->query($sql) === TRUE) {
		    echo "New record created successfully";
		    header("Location: ./daa.php");
		} else {
...
<?php
	$sql = "SELECT * FROM threads WHERE Topic='DAA' AND IsMainThread='1'";
