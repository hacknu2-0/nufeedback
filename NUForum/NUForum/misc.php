<?php
	...
	if(isset($_POST['title'])){
		...
		VALUES ('".$_SESSION['username']."', '1', '".date("Y-m-d h:i:sa")."', 'MISC', '".$_POST['title']."', '".$_POST['text']."')";
...
<?php
	$sql = "SELECT * FROM threads WHERE Topic='MISC' AND IsMainThread='1'";
